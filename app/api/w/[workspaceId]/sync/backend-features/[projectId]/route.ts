/**
 * Workspace-Scoped Backend Features Sync API Route
 *
 * GET: Pull backend features for a project from server
 * POST: Push backend features for a project to server
 */
...
export async function GET(
  ...
  try {
    ...
    // Strip secret values before returning
    ...
    logger.error('[API /api/w/[workspaceId]/sync/backend-features GET] Error:', error);
    return NextResponse.json(
...
export async function POST(
  ...
  try {
    ...
    logger.error('[API /api/w/[workspaceId]/sync/backend-features POST] Error:', error);
    return NextResponse.json(
