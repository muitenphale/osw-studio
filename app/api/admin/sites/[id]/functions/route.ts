 ...
 *
 * GET  /api/admin/sites/[id]/functions - List all functions
 * POST /api/admin/sites/[id]/functions - Create a new function
 */
...
/**
 * GET - List all functions for a site
 */
...
export async function POST(
  ...
  try {
    ...
    const fn = siteDb.getFunction(id);
