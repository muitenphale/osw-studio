...
export function CreateSiteModal({
  ...
  const handleCreate = async () => {
    if (!projectId || !name) {
      setError('Project and site name are required');
      return;
    }
  ...
  // Auto-generate site name from selected project
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new site to publish a project. Sites let you manage publish settings
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            ...
            />
            <p className="text-xs text-muted-foreground">
              Display name for this published site
            </p>
          </div>
          ...
          <div className="grid gap-2">
            ...
            />
            <p className="text-xs text-muted-foreground">
              URL-friendly identifier for this site
            </p>
          </div>
